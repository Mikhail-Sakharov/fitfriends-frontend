...
function PopupBuyTraining({setModalOpened}: PopupBuyTrainingProps): JSX.Element {
  return (
    <main>
              ...
              <div className="popup__product">
                <div className="popup__product-image">
                  <picture>
                    ...
                    <img src="img/content/popup/popup-energy.jpg" srcSet="img/content/popup/popup-energy@2x.jpg 2x" width="98" height="80" alt=""/>
                  </picture>
                </div>
