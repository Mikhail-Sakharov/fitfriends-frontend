...
import {buyTrainingAction, fetchMyPurchasesAction} from '../../store/api-actions';
...
function PopupBuyTraining({training, setModalOpened}: PopupBuyTrainingProps): JSX.Element {
            ...
            <div className="popup__content popup__content--purchases">
              <div className="popup__product">
                <div className="popup__product-image">
                  <picture>
                    <img src={training.bgImageUrl} width="98" height="80" alt=""/>
                  </picture>
                </div>
