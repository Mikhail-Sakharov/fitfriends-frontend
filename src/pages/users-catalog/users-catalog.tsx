                  ...
                  <ul className="users-catalog__list">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                        ...
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-coach">
                          <svg width="12" height="12" aria-hidden="true">
                            <use xlinkHref="#icon-crown"></use>
                          </svg>
                        </div>
                        ...
                        <Link className="btn btn--dark-bg btn--medium thumbnail-user__button" to="#">Подробнее</Link>
                      </div>
                    </li>
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-13.webp, img/content/thumbnails/user-13@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-13.jpg" srcSet="img/content/thumbnails/user-13@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-14.webp, img/content/thumbnails/user-14@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-14.jpg" srcSet="img/content/thumbnails/user-14@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-15.webp, img/content/thumbnails/user-15@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-15.jpg" srcSet="img/content/thumbnails/user-15@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-16.webp, img/content/thumbnails/user-16@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-16.jpg" srcSet="img/content/thumbnails/user-16@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-17.webp, img/content/thumbnails/user-17@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-17.jpg" srcSet="img/content/thumbnails/user-17@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-18.webp, img/content/thumbnails/user-18@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-18.jpg" srcSet="img/content/thumbnails/user-18@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-19.webp, img/content/thumbnails/user-19@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-19.jpg" srcSet="img/content/thumbnails/user-19@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-20.webp, img/content/thumbnails/user-20@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-20.jpg" srcSet="img/content/thumbnails/user-20@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-21.webp, img/content/thumbnails/user-21@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-21.jpg" srcSet="img/content/thumbnails/user-21@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-22.webp, img/content/thumbnails/user-22@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-22.jpg" srcSet="img/content/thumbnails/user-22@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-coach">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-23.webp, img/content/thumbnails/user-23@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-23.jpg" srcSet="img/content/thumbnails/user-23@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__header">
                    ...
                    <li className="users-catalog__item">
                      <div className="thumbnail-user thumbnail-user--role-user">
                        <div className="thumbnail-user__image">
                          <picture>
                            <source type="image/webp" srcSet="img/content/thumbnails/user-24.webp, img/content/thumbnails/user-24@2x.webp 2x"/>
                            <img src="img/content/thumbnails/user-24.jpg" srcSet="img/content/thumbnails/user-24@2x.jpg 2x" width="82" height="82" alt=""/>
                          </picture>
                        </div>
                        <div className="thumbnail-user__top-status thumbnail-user__top-status--role-user">
                          <svg width="12" height="12" aria-hidden="true">
