...
import {AppRoute, MAX_TRAININGS_COUNT_PER_PAGE} from '../../const';
import {useAppSelector} from '../../hooks';
import TrainingCatalogFilter from '../../components/training-catalog-filter/training-catalog-filter';
...
function TrainingCatalog(): JSX.Element {
  ...
  const filteredTrainingCatalog = useAppSelector(getFilteredTrainingCatalog);

  const [trainingsPage, setTrainingsPage] = useState(1);
  const pagesCount = Math.ceil(filteredTrainingCatalog.length / MAX_TRAININGS_COUNT_PER_PAGE);
              ...
              <div className="gym-catalog-form">
                ...
                <div className="gym-catalog-form__wrapper">
                  <button
                    ...
                    className="btn-flat btn-flat--underlined gym-catalog-form__btnback" type="button"
                  >
